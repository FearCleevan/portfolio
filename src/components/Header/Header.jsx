...
const Header = ({ isDarkMode, toggleDarkMode }) => {
    ...
    const handleSendEmail = () => {
        const email = 'fearcleevan123@gmail.com';
        const subject = 'Regarding your portfolio'; // Example subject
        const body = 'Hello Peter Paul,\n\nI came across your portfolio and...'; // Example body
